...
public class DataIOException : SubstrateException {
    ...
    public DataIOException(string message, Exception innerException) : base(message, innerException) { }
    ...
    protected DataIOException(SerializationInfo info, StreamingContext context) : base(info, context) { }
}
