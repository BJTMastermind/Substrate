...
public class EntityCreeper : EntityMob {
    ...
    public bool Powered {
        get { return this._powered ?? false; }
        set { this._powered = value; }
    }

    protected EntityCreeper(string id) : base(id) { }

    public EntityCreeper() : this(TypeId) { }

    public EntityCreeper(TypedEntity e) : base(e) {
        EntityCreeper e2 = e as EntityCreeper;
        if(e2 != null) {
            this._powered = e2._powered;
        }
    }
    ...
    public override TypedEntity LoadTree(TagNode tree) {
        ...
        if(ctree.ContainsKey("powered")) {
            this._powered = ctree["powered"].ToTagByte() == 1;
        }
        return this;
    }
    ...
    public override TagNode BuildTree() {
        ...
        if(this._powered != null) {
            tree["powered"] = new TagNodeByte((byte) ((this._powered ?? false) ? 1 : 0));
        }
        return tree;
    }
