...
public class EntityFallingSand : TypedEntity {
    ...
    public int Tile {
        ...
        set { this._tile = (byte) value; }
    }

    protected EntityFallingSand(string id) : base(id) { }

    public EntityFallingSand() : this(TypeId) { }

    public EntityFallingSand(TypedEntity e) : base(e) {
    ...
    public override TypedEntity LoadTree(TagNode tree) {
        ...
        this._tile = ctree["Tile"].ToTagByte();
    ...
    public override TagNode BuildTree() {
        ...
        tree["Tile"] = new TagNodeByte(this._tile);
