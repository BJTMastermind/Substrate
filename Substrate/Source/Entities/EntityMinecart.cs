...
public class EntityMinecart : TypedEntity {
    ...
    protected EntityMinecart(string id) : base(id) { }

    public EntityMinecart() : this(TypeId) { }

    public EntityMinecart(TypedEntity e) : base(e) {
    ...
    public override TypedEntity LoadTree(TagNode tree) {
        ...
        this._type = (CartType) ctree["Type"].ToTagInt().Data;
    ...
    public override TagNode BuildTree() {
        ...
        tree["Type"] = new TagNodeInt((int) this._type);
