...
public class EntityPig : EntityAnimal {
    ...
    public bool HasSaddle {
        get { return this._saddle; }
        set { this._saddle = value; }
    }

    protected EntityPig(string id) : base(id) { }

    public EntityPig() : this(TypeId) { }

    public EntityPig(TypedEntity e) : base(e) {
        EntityPig e2 = e as EntityPig;
        if(e2 != null) {
            this._saddle = e2._saddle;
        }
    }
    ...
    public override TypedEntity LoadTree(TagNode tree) {
        ...
        this._saddle = ctree["Saddle"].ToTagByte() == 1;
    ...
    public override TagNode BuildTree() {
        ...
        tree["Saddle"] = new TagNodeByte((byte) (this._saddle ? 1 : 0));
