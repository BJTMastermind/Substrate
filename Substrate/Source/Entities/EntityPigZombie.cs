...
public class EntityPigZombie : EntityMob {
    ...
    public int Anger {
        get { return this._anger; }
        set { this._anger = (short) value; }
    }

    protected EntityPigZombie(string id) : base(id) { }

    public EntityPigZombie() : this(TypeId) { }

    public EntityPigZombie(TypedEntity e) : base(e) {
        EntityPigZombie e2 = e as EntityPigZombie;
        if(e2 != null) {
            this._anger = e2._anger;
        }
    }
    ...
    public override TypedEntity LoadTree(TagNode tree) {
        ...
        this._anger = ctree["Anger"].ToTagShort();
    ...
    public override TagNode BuildTree() {
        ...
        tree["Anger"] = new TagNodeShort(this._anger);
