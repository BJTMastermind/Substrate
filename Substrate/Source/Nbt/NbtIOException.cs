...
public class NbtIOException : SubstrateException {
    ...
    public NbtIOException(string message, Exception innerException) : base(message, innerException) { }
    ...
    protected NbtIOException(SerializationInfo info, StreamingContext context) : base(info, context) { }
}
