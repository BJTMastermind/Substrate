...
public class PlayerManager : IPlayerManager, IEnumerable<Player> {
    ...
    protected PlayerFile GetPlayerFile(string name) {
        return new PlayerFile(this.playerPath, name);
    }
    ...
    public bool PlayerExists(string name) {
        return new PlayerFile(this.playerPath, name).Exists();
    }
    ...
    public void DeletePlayer(string name) {
        try {
            new PlayerFile(this.playerPath, name).Delete();
        } catch(Exception ex) {
    ...
    private class Enumerator : IEnumerator<Player> {
        ...
        public Enumerator(PlayerManager cfm) {
            ...
            if(!Directory.Exists(this.pm.playerPath)) {
        ...
        public bool MoveNext() {
            ...
            string name = this.names.Dequeue();
            this.curPlayer = this.pm.GetPlayer(name);
        ...
        public void Reset() {
            ...
            string[] files = Directory.GetFiles(this.pm.playerPath);
            foreach(string file in files) {
                ...
                this.names.Enqueue(PlayerFile.NameFromFilename(basename));
            }
        }
        ...
        protected static Regex namePattern = new Regex(".+\\.dat$");
    }
}
