...
public class TileEntityEnchantmentTable : TileEntity {
    ...
    protected TileEntityEnchantmentTable(string id) : base(id) { }

    public TileEntityEnchantmentTable() : this(TypeId) { }

    public TileEntityEnchantmentTable(TileEntity te) : base(te) { }
